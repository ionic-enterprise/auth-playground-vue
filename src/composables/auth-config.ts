...
export default () => {
  ...
  return {
    auth0Config: isPlatform('hybrid') ? mobileAuth0Config : webAuth0Config,
    awsConfig: isPlatform('hybrid') ? mobileAWSConfig : webAWSConfig,
    azureConfig: isPlatform('hybrid') ? mobileAzureConfig : webAzureConfig,
  };
};
